...
a = Analysis(
    ['C:\\Dev\\Tablerreur-1\\src\\spreadsheet_qa\\web\\launcher.py'],
    pathex=[],
    binaries=[],
    datas=[('C:\\Dev\\Tablerreur-1\\src\\spreadsheet_qa\\resources', 'spreadsheet_qa/resources'), ('C:\\Dev\\Tablerreur-1\\src\\spreadsheet_qa\\web\\static', 'spreadsheet_qa/web/static')],
